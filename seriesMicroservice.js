// seriesMicroservice.js 
const grpc = require('@grpc/grpc-js'); 
const protoLoader = require('@grpc/proto-loader'); 
// Charger le fichier series.proto 
...
server.addService(seriesProto.seriesService.service, seriesService); 
const port = 50052; 
